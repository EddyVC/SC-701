...
namespace BE.API.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<ActionResult<models.Categories>> PostCategories(models.Categories categories)
        {
            try
            {
                var mapAux = _mapper.Map<models.Categories, data.Categories>(categories);
                new BE.BS.Categories(_context).Insert(mapAux);
            }
            catch (Exception )
            {
                BadRequest();
        ...
        public async Task<ActionResult<models.Categories>> DeleteCategories(int id)
        {
            ...
            var mapAux = _mapper.Map<data.Categories, models.Categories>(categories);
            return mapAux;
        }
